...
export const AffectedTypeEditPage = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            const response = await axios.get(`http://localhost:8000/api/affectedtypes/${id}`);
    ...
    const submitHandeler = async (e) => {
        ...
        await axios.post(`http://localhost:8000/api/affectedtypes/${id}`, formData)
            .then((response) => {
                if (response?.data?.success) {
                    navigate('/be/affectedtypes')
                    toast.success('Affectedtypes updated successfully!', {
                        ...
                        <div className="aid-control">
                            ...
                            <form action="" onSubmit={submitHandeler}>
                                ...
                                <div className="form-group">
                                    ...
                                    <input type="text" id="title" value={title} onChange={titleChangeHandeler} placeholder="Enter Title" />
                                </div>
