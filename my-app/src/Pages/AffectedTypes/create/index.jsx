...
export const AffectedTypeCreatePage = () => {
    ...
    const submitHandeler = async (e) => {
        ...
        await axios.post('http://localhost:8000/api/affectedtypes', formData)
            .then((response) => {
                        ...
                        <div className="aid-control">
                            ...
                            <form action="" onSubmit={submitHandeler}>
                                ...
                                <div className="form-group">
                                    ...
                                    <input type="text" name="title" id="title" placeholder="Enter Affeted Type" required value={title} onChange={titleChangeHandeler}/>
                                </div>
