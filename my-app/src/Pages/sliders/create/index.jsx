...
export const SLiderCreatePage = () => {
    ...
    const shortTitleChangeHandeler = (e) => {
                        ...
                        <div className="aid-control">
                            ...
                            <form action="" onSubmit={submitHandeler}>
                                ...
                                <div className="form-group">
                                    ...
                                    <input type="text" id="title" name="shorttitle" value={short_title} onChange={shortTitleChangeHandeler} placeholder="Enter Short Title"/>
                                </div>
                                <div className="form-group">
