...
export const GallaryEditPage = () => {
    ...
    const submitHandeler = async (e) => {
        ...
        await axios.post(`http://localhost:8000/api/gallerys/${id}`, formData)
            .then((response) => {
                if (response?.data?.success) {
                    navigate('/be/gallaries')
                    toast.success('Gallary updated successfully!', {
