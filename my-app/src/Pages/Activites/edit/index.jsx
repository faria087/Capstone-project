...
export const ActivityEditPage = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            const response = await axios.get(`http://localhost:8000/api/activities/${id}`);
    ...
    const submitHandeler = async (e) => {
        ...
        await axios.post(`http://localhost:8000/api/activities/${id}`, formData)
            .then((response) => {
                if (response?.data?.success) {
                    navigate('/be/activities')
                        ...
                        <div className="aid-control">
                            ...
                            <form action="" onSubmit={submitHandeler}>
                                <div className="form-group">
                                    ...
                                    <input type="text" id="tag" tag="tag" value={tag} onChange={tagChangeHandeler} />
                                </div>
                                <div className="form-group">
