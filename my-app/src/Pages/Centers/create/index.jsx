...
export const CenterCreatePage = () => {
    ...
    const submitHandeler = async (e) => {
        ...
        await axios.post('http://localhost:8000/api/centers', formData)
            .then((response) => {
                if (response?.data?.success) {
                    navigate(-1)
                }
                        ...
                        <div className="aid-control">
                            ...
                            <form action="" onSubmit={submitHandeler}>
                                ...
                                <div className="form-group">
                                    ...
                                    <input type="text" id="capacity" name="capacity" value={capacity} onChange={capacityChangeHandeler} placeholder="Enter capacity"/>
                                </div>
